...
class LaunchImage(tables.LinkAction):
    ...
    def get_link_url(self, datum):
        ...
        source_type = "amazon_images_id"
        params = urlencode({
                        "source_types":source_type,
                        "amazon_images_id": self.table.get_object_id(datum)
                        })
...
class AmazonImagesTable(tables.DataTable):
    STATUS_CHOICES = (
        ("active", True),
        ("saving", None),
        ("queued", None),
    ...
    ids = tables.Column("id",link=("horizon:amazon:images:amazonimage:detail"),verbose_name=_("Id"))
