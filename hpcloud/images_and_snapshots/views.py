...
class IndexView(tables.MultiTableView):
    ...
    template_name = 'hpcloud/images_and_snapshots/index.html'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'hpcloud/images_and_snapshots/snapshots/detail.html'
