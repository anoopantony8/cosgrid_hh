...
from hpcloud.utils import filters
...
class DeleteGroup(tables.DeleteAction):
    ...
    def allowed(self, request, security_group=None):
        if security_group:
            if "Delete SG" in request.session['user_policies'].get(request.user.hpname):
                return True
            else:
                return False
        return False
...
class CreateGroup(tables.LinkAction):
    ...
    url = "horizon:hpcloud:access_and_security:security_groups:create"
    classes = ("ajax-modal", "btn-create")

    def allowed(self, request, volume=None):
        if "Create SG" in request.session['user_policies'].get(request.user.hpname):
            return True
        else:
            return False
...
class EditGroup(tables.LinkAction):
    ...
    url = "horizon:hpcloud:access_and_security:security_groups:update"
...
class EditRules(tables.LinkAction):
    ...
    url = "horizon:hpcloud:access_and_security:security_groups:detail"
    classes = ("btn-edit")
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:hpcloud:access_and_security:security_groups:add_rule"
    classes = ("ajax-modal", "btn-create")
...
class DeleteRule(tables.DeleteAction):
    ...
    def get_success_url(self, request):
        ...
        return reverse("horizon:hpcloud:access_and_security:"
