...
from horizon import exceptions,forms,tables,tabs,workflows
from hpcloud import api
from hpcloud.instances \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'hpcloud/instances/index.html'
...
class LaunchInstanceView(workflows.WorkflowView):
    ...
    def get_initial(self):
        ...
        initial['project_id'] = self.request.user.hp_attr.tenant_id
...
def vnc(request, instance_id):
    try:
        ...
        redirect = reverse("horizon:hpcloud:instances:index")
...
class UpdateView(workflows.WorkflowView):
    ...
    success_url = reverse_lazy("horizon:hpcloud:instances:index")
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/instances/rebuild.html'
    success_url = reverse_lazy('horizon:hpcloud:instances:index')
...
class DetailView(tabs.TabView):
    ...
    template_name = 'hpcloud/instances/detail.html'
