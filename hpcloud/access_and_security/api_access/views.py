...
def download_ec2_bundle(request):
    ...
    template = 'hpcloud/access_and_security/api_access/ec2rc.sh.template'
    try:
...
def download_rc_file(request):
    ...
    tenant_name = request.user.hp_attr.tenant_name

    template = 'hpcloud/access_and_security/api_access/openrc.sh.template'
