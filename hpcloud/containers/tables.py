...
class ViewContainer(tables.LinkAction):
    ...
    url = "horizon:hpcloud:containers:container_detail"
...
class CreateContainer(tables.LinkAction):
    ...
    url = "horizon:hpcloud:containers:create"
...
class ListObjects(tables.LinkAction):
    ...
    url = "horizon:hpcloud:containers:index"
    classes = ("btn-list",)
...
class UploadObject(tables.LinkAction):
    ...
    url = "horizon:hpcloud:containers:object_upload"
...
def get_container_link(container):
    return reverse("horizon:hpcloud:containers:index",
...
class ViewObject(tables.LinkAction):
    name = "view"
    verbose_name = _("View Details")
    url = "horizon:hpcloud:containers:object_detail"
    classes = ("ajax-modal", "btn-view")
...
class CopyObject(tables.LinkAction):
    name = "copy"
    verbose_name = _("Copy")
    url = "horizon:hpcloud:containers:object_copy"
...
class DownloadObject(tables.LinkAction):
    ...
    url = "horizon:hpcloud:containers:object_download"
