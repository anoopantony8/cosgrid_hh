...
from horizon import browsers,exceptions,forms
from hpcloud import api
from hpcloud.api import swift
from hpcloud.containers \
    import browsers as project_browsers
from hpcloud.containers \
    import forms as project_forms
from hpcloud.containers import tables
import os


class ContainerView(browsers.ResourceBrowserView):
    browser_class = project_browsers.ContainerBrowser
    template_name = "hpcloud/containers/index.html"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/containers/create.html'
    success_url = "horizon:hpcloud:containers:index"
...
class UploadView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/containers/upload.html'
    success_url = "horizon:hpcloud:containers:index"
...
def object_download(request, container_name, object_path):
    try:
        ...
        redirect = reverse("horizon:hpcloud:containers:index")
...
class CopyView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/containers/copy.html'
    success_url = "horizon:hpcloud:containers:index"
...
class ContainerDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'hpcloud/containers/container_detail.html'
...
class ObjectDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'hpcloud/containers/object_detail.html'
