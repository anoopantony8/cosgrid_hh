...
from horizon import exceptions,forms,tabs
from hpcloud import api
from hpcloud.routers.ports \
...
class AddInterfaceView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/routers/ports/create.html'
    success_url = 'horizon:hpcloud:routers:detail'
    failure_url = 'horizon:hpcloud:routers:detail'
...
class SetGatewayView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/routers/ports/setgateway.html'
    success_url = 'horizon:hpcloud:routers:index'
    failure_url = 'horizon:hpcloud:routers:index'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'hpcloud/networks/ports/detail.html'
