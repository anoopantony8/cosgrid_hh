...
class IndexView(tables.DataTableView):
    ...
    template_name = 'hpcloud/users/index.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/users/update.html'
    success_url = reverse_lazy('horizon:hpcloud:users:index')
    ...
    def get_object(self):
        if not hasattr(self, "_object"):
            try:
                ...
                redirect = reverse("horizon:hpcloud:users:index")
                exceptions.handle(self.request,
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/users/create.html'
    success_url = reverse_lazy('horizon:hpcloud:users:index')
