...
class DetailView(tables.DataTableView):
    ...
    template_name = 'hpcloud/access_and_security/security_groups/detail.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/access_and_security/security_groups/update.html'
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/access_and_security/security_groups/add_rule.html'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/access_and_security/security_groups/create.html'
    success_url = reverse_lazy('horizon:hpcloud:access_and_security:index')
