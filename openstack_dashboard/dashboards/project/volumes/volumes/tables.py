...
class DeleteVolume(tables.DeleteAction):
    ...
    def allowed(self, request, volume=None):
        if volume:
            if "Delete Volume" in request.session['user_policies'].get(request.user.openstackname):
...
class CreateVolume(tables.LinkAction):
    ...
    def allowed(self, request, volume=None):
        ...
        if "Create Volume" in request.session['user_policies'].get(request.user.openstackname):
            return True
        else:
            return False
