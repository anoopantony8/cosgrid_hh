...
class IndexView(tables.DataTableView):
    ...
    template_name = 'hpcloud/routers/index.html'
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'hpcloud/routers/detail.html'
    failure_url = reverse_lazy('horizon:hpcloud:routers:index')
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/routers/create.html'
    success_url = reverse_lazy("horizon:hpcloud:routers:index")
