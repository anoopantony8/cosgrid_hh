...
from horizon.utils import fields,functions
from hpcloud import api
from hpcloud.api import cinder
from hpcloud.images_and_snapshots import utils
...
class SelectProjectUserAction(workflows.Action):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        projects = [(tenant['id'], tenant['name'])
                    for tenant in request.user.hp_attr.authorized_tenants]
...
class SetInstanceDetailsAction(workflows.Action):
    ...
    class Meta:
        name = _("Details")
        help_text_template = ("hpcloud/instances/"
...
KEYPAIR_IMPORT_URL = "horizon:hpcloud:access_and_security:keypairs:import"
...
class SetNetwork(workflows.Step):
    ...
    if api.neutron.is_port_profiles_supported():
        ...
        template_name = "hpcloud/instances/_update_networks.html"
...
class LaunchInstance(workflows.Workflow):
    ...
    success_url = "horizon:hpcloud:instances:index"
