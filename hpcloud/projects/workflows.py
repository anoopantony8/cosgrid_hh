...
from hpcloud.api import base,cinder,keystone,nova
from hpcloud.usage import quotas

INDEX_URL = "horizon:hpcloud:projects:index"
ADD_USER_URL = "horizon:hpcloud:projects:create_user"
...
class CreateProject(workflows.Workflow):
    ...
    success_url = "horizon:hpcloud:projects:index"
