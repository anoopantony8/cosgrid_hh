...
class DeleteNetwork(CheckNetworkEditable, tables.DeleteAction):
    ...
    def delete(self, request, network_id):
        try:
            ...
            LOG.info(msg)
            redirect = reverse("horizon:hpcloud:networks:index")
...
class CreateNetwork(tables.LinkAction):
    ...
    url = "horizon:hpcloud:networks:create"
...
class EditNetwork(CheckNetworkEditable, tables.LinkAction):
    ...
    url = "horizon:hpcloud:networks:update"
...
class CreateSubnet(CheckNetworkEditable, tables.LinkAction):
    ...
    url = "horizon:hpcloud:networks:addsubnet"
    classes = ("ajax-modal", "btn-create")


def get_subnets(network):
    template_name = 'hpcloud/networks/_network_ips.html'
...
class NetworksTable(tables.DataTable):
    name = tables.Column("name",
                         verbose_name=_("Name"),
                         link='horizon:hpcloud:networks:detail')
