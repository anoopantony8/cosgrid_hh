...
from openstack_dashboard.dashboards.project.overview import forms as project_forms
from django.core.urlresolvers import reverse_lazy
from horizon import forms
from openstack_dashboard.api.base import get_accounts
...
class AccountChange(forms.ModalFormView):
    ...
    def get_initial(self):
        openstack_accounts = get_accounts(self.request)
        return { 'account_choices':openstack_accounts }
