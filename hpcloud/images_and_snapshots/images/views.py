...
from hpcloud.images_and_snapshots.images \
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/images_and_snapshots/images/create.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/images_and_snapshots/images/update.html'
    success_url = reverse_lazy("horizon:hpcloud:images_and_snapshots:index")
    ...
    def get_object(self):
        if not hasattr(self, "_object"):
            try:
                ...
                url = reverse('horizon:hpcloud:images_and_snapshots:index')
...
class DetailView(tabs.TabView):
    ...
    template_name = 'hpcloud/images_and_snapshots/images/detail.html'
