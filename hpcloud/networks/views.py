...
from horizon import exceptions,forms,tables,workflows
from hpcloud import api
from hpcloud.networks \
    import forms as project_forms
from hpcloud.networks.ports \
    import tables as port_tables
from hpcloud.networks.subnets \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'hpcloud/networks/index.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'hpcloud/networks/update.html'
    context_object_name = 'network'
    success_url = reverse_lazy("horizon:hpcloud:networks:index")
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'hpcloud/networks/detail.html'
    failure_url = reverse_lazy('horizon:hpcloud:networks:index')
